...
if __name__ == "__main__":
    ...
    print("SVM with Dimensionality Reduction using PCA down to 500 features (classes: 0.001|4)")
    ...
    plt.title('SVM (500d, classes: 0.001|4) Precision-Recall curve: AP={0:0.2f}'.format(average_precision))
    plt.savefig('data/svm500d_precisionRecall.png')
    plt.show()
