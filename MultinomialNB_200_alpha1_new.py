...
if __name__ == "__main__":
    ...
    print("Multinomial Naive Bayes with 200 features and alpha = 1")
    ...
    plt.title('Multinomial NB 200d Precision-Recall curve: AP={0:0.2f}'.format(average_precision))
    plt.show()
    plt.savefig('data/MultinomialNB200d_alpha1_precisionRecall.png')