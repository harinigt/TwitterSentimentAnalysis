...
if __name__ == "__main__":
    ...
    print("W2V SVM with 500 features")
    ...
    plt.title('W2V SVM 500d Precision-Recall curve: AP={0:0.2f}'.format(average_precision))
    plt.savefig('data/w2v_svm_500d_precisionRecall.png')
    plt.show()
