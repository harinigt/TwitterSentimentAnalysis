...
if __name__ == "__main__":
    ...
    print("SVM with Dimensionality Reduction using PCA down to 100 features")
    ...
    plt.xlabel('X0')
    plt.ylabel('X1')
    plt.title('SVM with Dimensionality Reduction using PCA down to 100 features')
    plt.show()
    ...
    plt.title('SVM (100d) Precision-Recall curve: AP={0:0.2f}'.format(average_precision))
    plt.show()
